...
public abstract class IDaoImpl<Data> implements IDao<Data>{
	...
	protected IDaoImpl(){
    	clazz = (Class<Data>) getClassGenricType(getClass());
	...
	@Override
	public List<Data> getByCondtion(Map<String,Object> conditions) throws CIPDaoException{
		try {
			...
			if(size == 0)
				...
				return jdbcTemplate.query(sql.toString(),params, rm);
...
//		log.info("sql:"+sql);
	...
	// 查询条件:子类必须实现
	protected abstract String generateWhere(Object... args);
