...
@Repository
public class CIP_admin_auth_userDaoImpl extends IDaoImpl<CIP_admin_auth_userPO> 
						implements CIP_admin_auth_userDao {
	
	private final BeanPropertyRowMapper<CIP_admin_auth_userData> dataRM = BeanPropertyRowMapper.newInstance(CIP_admin_auth_userData.class);
	
	public CIP_admin_auth_userDaoImpl() {
		super();
		this.tableName = "cip_admin_auth_user";
	...
	private CIP_admin_auth_userMapper mapperRM = new CIP_admin_auth_userMapper();
