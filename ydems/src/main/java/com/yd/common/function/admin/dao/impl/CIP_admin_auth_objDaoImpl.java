...
@Repository
public class CIP_admin_auth_objDaoImpl extends IDaoImpl<CIP_admin_auth_objPO> 
						implements CIP_admin_auth_objDao {
	
	private final BeanPropertyRowMapper<CIP_admin_auth_objData> dataRM = BeanPropertyRowMapper.newInstance(CIP_admin_auth_objData.class);
	
	public CIP_admin_auth_objDaoImpl() {
		super();
		this.tableName = "cip_admin_auth_obj";
	...
	private CIP_admin_auth_objMapper mapperRM = new CIP_admin_auth_objMapper();
