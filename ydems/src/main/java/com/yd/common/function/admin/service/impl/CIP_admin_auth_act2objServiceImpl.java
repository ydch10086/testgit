...
@Service
public class CIP_admin_auth_act2objServiceImpl implements CIP_admin_auth_act2objService {
	
	@Autowired
	private CIP_admin_auth_act2objDao dataDao = null;
	@Autowired
	 ...
	 */
	@Override
	public void updateData(CIP_admin_auth_act2objVO vo, CIPRuntimeOperator operateInf){
		//TODO
		CIP_admin_auth_act2objPO po = vo.toPO();
		Object[] keys = po.getKeys();
		CIP_admin_auth_act2objPO po0 = dataDao.getSingle(keys);
		if( po0 == null ){
	 ...
	 */
	@Override
	public void addData(CIP_admin_auth_act2objVO vo, CIPRuntimeOperator operateInf){
		CIP_admin_auth_act2objPO po = vo.toPO();
		Object[] keys = po.getKeys();
		CIP_admin_auth_act2objPO po0 = dataDao.getSingle(keys);
		if( po0!= null ){
	...
	public CIP_admin_auth_act2objVO getData(Object[] keys ){
		CIP_admin_auth_act2objPO  po = dataDao.getSingle(keys);
		if(po == null)
			throw new CIPServiceException(CIPErrorCode.ERROR_RECORD_NOT_EXISTS);
	...
	public List<CIP_admin_auth_act2objData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		...
		List<CIP_admin_auth_act2objData> datas = dataDao.searchData(page, conditions);
		return datas;
	}
	...
	public List<Map<String, Object>> exportEntities(CIPPageInfo page,CIPReqCondition[] conditions,
		...
		if(xFirst){
			...
			log.setOp_table_id("cip_admin_auth_act2obj");
			log.setOp_obj_id("");
			log.setOp_type("E");
