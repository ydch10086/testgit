...
/**
 * <p>Data实体类</p>
 * <p>View: cip_admin_domain - 数据域信息</p>
 * 用于检索数据，建立在视图基础上
 * @since 2015-05-21 12:44:17
 */
public class CIP_admin_domainData {
	...
	* 文本描述信息
	*/
	private String is_null_flag_name;
	/**
	* 文本描述信息
	*/
	...
	public String getIs_null_flag_name(){
        return this.is_null_flag_name;
    }
    public void setIs_null_flag_name(String is_null_flag_name){
        this.is_null_flag_name = is_null_flag_name;
    }
