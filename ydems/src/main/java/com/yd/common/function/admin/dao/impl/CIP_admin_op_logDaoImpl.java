...
/**
 * <p>Dao实现类</p>
 * <p>Class: admin_op_log - 系统操作日志</p>
 *
 * @since 2015-05-21 12:44:17
 */
 
@Repository
public class CIP_admin_op_logDaoImpl extends IDaoImpl<CIP_admin_op_logPO> 
						implements CIP_admin_op_logDao {
	
	private final BeanPropertyRowMapper<CIP_admin_op_logData> dataRM = BeanPropertyRowMapper.newInstance(CIP_admin_op_logData.class);
	
	public CIP_admin_op_logDaoImpl() {
		super();
		this.tableName = "cip_admin_op_log";
	...
	private CIP_admin_op_logMapper mapperRM = new CIP_admin_op_logMapper();
