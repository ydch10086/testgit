 ...
 */
public class CIP_admin_auth_act2objPO {
    ...
    */
	...
	public CIP_admin_auth_act2objVO toVO(){
		CIP_admin_auth_act2objVO vo = new CIP_admin_auth_act2objVO();
		...
		vo.setVal_src_type(val_src_type);
