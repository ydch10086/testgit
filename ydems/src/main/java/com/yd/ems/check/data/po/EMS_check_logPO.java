...
public class EMS_check_logPO {
    ...
    */
	...
	public EMS_check_logVO toVO(){
		EMS_check_logVO vo = new EMS_check_logVO();
		
    	vo.setCheck_are(check_are);
    	vo.setCheck_beg_time(check_beg_time);
    	vo.setCheck_end_time(check_end_time);
    	vo.setCheck_org(check_org);
		vo.setCheck_no(check_no);
		vo.setCheck_op(check_op);
