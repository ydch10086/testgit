...
@Repository
public class EMS_check_poi_logDaoImpl extends IDaoImpl<EMS_check_poi_logPO> 
						implements EMS_check_poi_logDao {
	
	private final BeanPropertyRowMapper<EMS_check_poi_logData> dataRM = BeanPropertyRowMapper.newInstance(EMS_check_poi_logData.class);
	
	public EMS_check_poi_logDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_check_poi_log";
	...
	private EMS_check_poi_logMapper mapperRM = new EMS_check_poi_logMapper();
