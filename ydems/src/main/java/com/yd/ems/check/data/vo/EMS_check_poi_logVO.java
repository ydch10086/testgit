 ...
 */
public class EMS_check_poi_logVO {
    ...
    */
	...
	public EMS_check_poi_logPO toPO(){
		EMS_check_poi_logPO po = new EMS_check_poi_logPO();
		
    	po.setPoi_no(poi_no);
		po.setObj_id(obj_id);
		po.setPoi_time(poi_time);
		po.setPoi_org(poi_org);
		po.setMod_type_txt(mod_type_txt);
