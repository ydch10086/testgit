...
@Repository
public class EMS_mainten_repair_planDaoImpl extends IDaoImpl<EMS_mainten_repair_planPO> 
						implements EMS_mainten_repair_planDao {
	
	private final BeanPropertyRowMapper<EMS_mainten_repair_planData> dataRM = BeanPropertyRowMapper.newInstance(EMS_mainten_repair_planData.class);
	
	public EMS_mainten_repair_planDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_mainten_repair_plan";
	...
	private EMS_mainten_repair_planMapper mapperRM = new EMS_mainten_repair_planMapper();
