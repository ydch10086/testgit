...
@Repository
public class EMS_mainten_scrap_planDaoImpl extends IDaoImpl<EMS_mainten_scrap_planPO> 
						implements EMS_mainten_scrap_planDao {
	
	private final BeanPropertyRowMapper<EMS_mainten_scrap_planData> dataRM = BeanPropertyRowMapper.newInstance(EMS_mainten_scrap_planData.class);
	
	public EMS_mainten_scrap_planDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_mainten_scrap_plan";
	...
	private EMS_mainten_scrap_planMapper mapperRM = new EMS_mainten_scrap_planMapper();
