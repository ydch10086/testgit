...
@Repository
public class EMS_mainten_logDaoImpl extends IDaoImpl<EMS_mainten_logPO> 
						implements EMS_mainten_logDao {
	
	private final BeanPropertyRowMapper<EMS_mainten_logData> dataRM = BeanPropertyRowMapper.newInstance(EMS_mainten_logData.class);
	
	public EMS_mainten_logDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_mainten_log";
	...
	private EMS_mainten_logMapper mapperRM = new EMS_mainten_logMapper();
