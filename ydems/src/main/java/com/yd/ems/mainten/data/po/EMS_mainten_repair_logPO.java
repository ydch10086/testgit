 ...
 */
public class EMS_mainten_repair_logPO {
    ...
    */
	...
	public EMS_mainten_repair_logVO toVO(){
		EMS_mainten_repair_logVO vo = new EMS_mainten_repair_logVO();
		
    	vo.setRep_no(rep_no);
		vo.setObj_id(obj_id);
		vo.setApply_date(apply_date);
		vo.setRep_org(rep_org);
		vo.setRep_orgeh(rep_orgeh);
		vo.setSup_code(sup_code);
		vo.setFault_txt(fault_txt);
		vo.setBegin_time(begin_time);
		vo.setEnd_time(end_time);
		vo.setFault_reason(fault_reason);
		vo.setFault_solution(fault_solution);
		vo.setFault_type(fault_type);
		vo.setCla_id(cla_id);
		vo.setRepair_stye_txt(repair_stye_txt);
		vo.setRepair_type(repair_type);
		vo.setRepair_emp_quan(repair_emp_quan);
		vo.setRepair_emp_no(repair_emp_no);
		vo.setRepair_emps_name(repair_emps_name);
		//vo.setRepair_process_no(repair_process_no);
		vo.setOp(op);
