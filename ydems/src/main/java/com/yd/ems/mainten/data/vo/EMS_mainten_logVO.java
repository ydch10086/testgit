 ...
 */
public class EMS_mainten_logVO {
    ...
    */
	...
	public EMS_mainten_logPO toPO(){
		EMS_mainten_logPO po = new EMS_mainten_logPO();
		
    	po.setMainten_no(mainten_no);
		po.setObj_id(obj_id);
		po.setMainten_org(mainten_org);
		po.setSup_code(sup_code);
		po.setSet_date(set_date);
		po.setBegin_date(begin_date);
		po.setMainten_op(mainten_op);
		po.setMainten_status(mainten_status);
