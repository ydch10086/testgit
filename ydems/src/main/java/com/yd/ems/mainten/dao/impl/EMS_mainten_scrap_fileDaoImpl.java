package com.yd.ems.mainten.dao.impl;
...
/**
 * <p>Dao实现类</p>
 * <p>Class: mainten_scrap_file -</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_mainten_scrap_fileDaoImpl extends IDaoImpl<EMS_mainten_scrap_filePO> 
						implements EMS_mainten_scrap_fileDao {
	
	private final BeanPropertyRowMapper<EMS_mainten_scrap_fileData> dataRM = BeanPropertyRowMapper.newInstance(EMS_mainten_scrap_fileData.class);
	
	public EMS_mainten_scrap_fileDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_mainten_scrap_file";
	...
	private EMS_mainten_scrap_fileMapper mapperRM = new EMS_mainten_scrap_fileMapper();
