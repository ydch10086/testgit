...
import com.yd.ems.mainten.dao.EMS_mainten_scrap_planDao;
...
@Service
public class EMS_mainten_scrap_planServiceImpl implements EMS_mainten_scrap_planService {
	
	@Autowired
	private EMS_mainten_scrap_planDao dataDao = null;
	@Autowired
	 ...
	 */
	@Override
	public void updateData(EMS_mainten_scrap_planVO vo, CIPRuntimeOperator operateInf){
		//TODO
		EMS_mainten_scrap_planPO po = vo.toPO();
		Object[] keys = po.getKeys();
		EMS_mainten_scrap_planPO po0 = dataDao.getSingle(keys);
		if( po0 == null ){
	 ...
	 */
	@Override
	public void addData(EMS_mainten_scrap_planVO vo, CIPRuntimeOperator operateInf){
		EMS_mainten_scrap_planPO po = vo.toPO();
		Object[] keys = po.getKeys();
		EMS_mainten_scrap_planPO po0 = dataDao.getSingle(keys);
		if( po0!= null ){
	...
	public EMS_mainten_scrap_planVO getData(Object[] keys ){
		EMS_mainten_scrap_planPO  po = dataDao.getSingle(keys);
		if(po == null)
			throw new CIPServiceException(CIPErrorCode.ERROR_RECORD_NOT_EXISTS);
	...
	public List<EMS_mainten_scrap_planData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		...
		List<EMS_mainten_scrap_planData> datas = dataDao.searchData(page, conditions);
		return datas;
	}
	...
	public List<Map<String, Object>> exportEntities(CIPPageInfo page,CIPReqCondition[] conditions,
		...
		if(xFirst){
			...
			log.setOp_table_id("em_mainten_scrap_plan");
			log.setOp_obj_id("");
			log.setOp_type("E");
	 ...
	 */
	@Override
	public void updateScrapData(EMS_mainten_scrap_planVO vo,
			CIPRuntimeOperator operateInf) {
		EMS_mainten_scrap_planPO po = vo.toScrapPO();
		Object[] keys = po.getKeys();
		EMS_mainten_scrap_planPO po0 = dataDao.getSingle(keys);
		if( po0 == null ){
			throw new CIPServiceException(CIPErrorCode.ERROR_RECORD_NOT_EXISTS);
