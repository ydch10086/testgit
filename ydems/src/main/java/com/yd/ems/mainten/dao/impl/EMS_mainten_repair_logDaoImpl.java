...
@Repository
public class EMS_mainten_repair_logDaoImpl extends IDaoImpl<EMS_mainten_repair_logPO> 
						implements EMS_mainten_repair_logDao {
	
	private final BeanPropertyRowMapper<EMS_mainten_repair_logData> dataRM = BeanPropertyRowMapper.newInstance(EMS_mainten_repair_logData.class);
	
	public EMS_mainten_repair_logDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_mainten_repair_log";
	...
	private EMS_mainten_repair_logMapper mapperRM = new EMS_mainten_repair_logMapper();
