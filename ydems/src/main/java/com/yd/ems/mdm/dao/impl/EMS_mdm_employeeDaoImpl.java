package com.yd.ems.mdm.dao.impl;
...
@Repository
public class EMS_mdm_employeeDaoImpl extends IDaoImpl<EMS_mdm_employeePO> 
						implements EMS_mdm_employeeDao {
	
	private final BeanPropertyRowMapper<EMS_mdm_employeeData> dataRM = BeanPropertyRowMapper.newInstance(EMS_mdm_employeeData.class);
	
	public EMS_mdm_employeeDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_mdm_employee";
	...
	private EMS_mdm_employeeMapper mapperRM = new EMS_mdm_employeeMapper();
