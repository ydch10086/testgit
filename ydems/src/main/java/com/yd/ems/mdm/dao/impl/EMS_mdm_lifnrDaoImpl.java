...
@Repository
public class EMS_mdm_lifnrDaoImpl extends IDaoImpl<EMS_mdm_lifnrPO> 
						implements EMS_mdm_lifnrDao {
	
	private final BeanPropertyRowMapper<EMS_mdm_lifnrData> dataRM = BeanPropertyRowMapper.newInstance(EMS_mdm_lifnrData.class);
	
	public EMS_mdm_lifnrDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_mdm_lifnr";
	...
	private EMS_mdm_lifnrMapper mapperRM = new EMS_mdm_lifnrMapper();
