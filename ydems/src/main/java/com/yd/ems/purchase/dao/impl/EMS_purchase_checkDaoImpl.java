...
@Repository
public class EMS_purchase_checkDaoImpl extends IDaoImpl<EMS_purchase_checkPO> 
						implements EMS_purchase_checkDao {
	
	private final BeanPropertyRowMapper<EMS_purchase_checkData> dataRM = BeanPropertyRowMapper.newInstance(EMS_purchase_checkData.class);
	
	public EMS_purchase_checkDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_purchase_check";
	...
	private EMS_purchase_checkMapper mapperRM = new EMS_purchase_checkMapper();
