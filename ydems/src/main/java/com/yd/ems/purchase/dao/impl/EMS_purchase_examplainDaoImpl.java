...
import com.yd.ems.purchase.data.mapper.EMS_purchase_examplainMapper;
...
@Repository
public class EMS_purchase_examplainDaoImpl extends IDaoImpl<EMS_purchase_examplainPO> 
						implements EMS_purchase_examplainDao {
	
	private final BeanPropertyRowMapper<EMS_purchase_examplainData> dataRM = BeanPropertyRowMapper.newInstance(EMS_purchase_examplainData.class);
	
	public EMS_purchase_examplainDaoImpl() {
		super();
	...
	private EMS_purchase_examplainMapper mapperRM = new EMS_purchase_examplainMapper();
