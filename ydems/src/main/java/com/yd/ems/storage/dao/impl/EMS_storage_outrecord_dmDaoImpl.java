...
/**
 * <p>Dao实现类</p>
 * <p>Class: storage_outrecord_dm - 出库记录</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_storage_outrecord_dmDaoImpl extends IDaoImpl<EMS_storage_outrecord_dmPO> 
						implements EMS_storage_outrecord_dmDao {
	
	private final BeanPropertyRowMapper<EMS_storage_outrecord_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_storage_outrecord_dmData.class);
	
	public EMS_storage_outrecord_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_storage_outrecord_dm";
	...
	public List<EMS_storage_outrecord_dmData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		/*try{
			...
			List<Object> params = new ArrayList<Object>();
			String querySql = generateQuerySql(page, conditions, params);
			List<EMS_storage_outrecord_dmData> storelist;
			try {
	...
	private EMS_storage_outrecord_dmMapper mapperRM = new EMS_storage_outrecord_dmMapper();
