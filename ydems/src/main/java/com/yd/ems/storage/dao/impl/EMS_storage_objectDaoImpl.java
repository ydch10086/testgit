...
@Repository
public class EMS_storage_objectDaoImpl extends IDaoImpl<EMS_storage_objectPO> 
						implements EMS_storage_objectDao {
	
	private final BeanPropertyRowMapper<EMS_storage_objectData> dataRM = BeanPropertyRowMapper.newInstance(EMS_storage_objectData.class);
	
	public EMS_storage_objectDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_storage_object";
	...
	private EMS_storage_objectMapper mapperRM = new EMS_storage_objectMapper();
