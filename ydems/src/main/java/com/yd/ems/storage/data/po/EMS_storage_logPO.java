 ...
 */
public class EMS_storage_logPO {
    ...
    */
	...
	public EMS_storage_logVO toVO(){
		EMS_storage_logVO vo = new EMS_storage_logVO();
		
    	vo.setRep_no(rep_no);
		vo.setCla_id(cla_id);
		vo.setBus_time(bus_time);
		vo.setBegin_quan(begin_quan);
		vo.setAct_quan(act_quan);
		vo.setEnd_quan(end_quan);
		vo.setRep_unit(rep_unit);
		vo.setOp_type(op_type);
		vo.setOp_org(op_org);
		vo.setTo_org(to_org);
		vo.setFrom_org(from_org);
