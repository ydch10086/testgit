...
import com.yd.ems.storage.dao.EMS_storage_inrecord_dmDao;
...
/**
 * <p>Service实现类</p>
 * <p>Class: EMS_storage_inrecord_dmService</p>
 *
 * @since 2015-05-29 02:42:14
 */

@Service
public class EMS_storage_inrecord_dmServiceImpl implements EMS_storage_inrecord_dmService {
	
	@Autowired
	private EMS_storage_inrecord_dmDao dataDao = null;
	@Autowired
	 ...
	 */
	@Override
	public void updateData(EMS_storage_inrecord_dmVO vo, CIPRuntimeOperator operateInf){
		//TODO
		EMS_storage_inrecord_dmPO po = vo.toPO();
		Object[] keys = po.getKeys();
		EMS_storage_inrecord_dmPO po0 = dataDao.getSingle(keys);
		if( po0 == null ){
	 ...
	 */
	@Override
	public void addData(EMS_storage_inrecord_dmVO vo, CIPRuntimeOperator operateInf){
		EMS_storage_inrecord_dmPO po = vo.toPO();
		Object[] keys = po.getKeys();
		EMS_storage_inrecord_dmPO po0 = dataDao.getSingle(keys);
		if( po0!= null ){
		...
		//TODO　添加记录基本判断
		po.setInrecord_id(dateStr+String.valueOf(randomNum));
	 ...
	 */		
	@Override
	public EMS_storage_inrecord_dmVO getData(Object[] keys ){
		EMS_storage_inrecord_dmPO  po = dataDao.getSingle(keys);
		if(po == null)
			throw new CIPServiceException(CIPErrorCode.ERROR_RECORD_NOT_EXISTS);
	...
	public List<EMS_storage_inrecord_dmData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		...
		List<EMS_storage_inrecord_dmData> datas = dataDao.searchData(page, conditions);
		return datas;
	}
	...
	public List<Map<String, Object>> exportEntities(CIPPageInfo page,CIPReqCondition[] conditions,
		...
		if(xFirst){
			...
			log.setOp_table_id("em_storage_inrecord_dm");
			log.setOp_obj_id("");
			log.setOp_type("E");
