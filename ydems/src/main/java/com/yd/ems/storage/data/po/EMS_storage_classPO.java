 ...
 */
public class EMS_storage_classPO {
    ...
    */
	...
	public EMS_storage_classVO toVO(){
		EMS_storage_classVO vo = new EMS_storage_classVO();
		
    	vo.setCla_id(cla_id);
		vo.setCla_type(cla_type);
		vo.setCla_sub_type(cla_sub_type);
		vo.setCla_txt(cla_txt);
		vo.setCla_bel_type(cla_bel_type);
		vo.setSup_code(sup_code);
		vo.setCla_bra(cla_bra);
		vo.setCla_orgeh(cla_orgeh);
		vo.setCla_imp_amt(cla_imp_amt);
		vo.setCla_amt(cla_amt);
		vo.setCla_exp_amt(cla_exp_amt);
		vo.setCla_unit(cla_unit);
