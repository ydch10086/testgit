...
@Service
public interface EMS_storage_spare_dmService {

	public void updateData(EMS_storage_spare_dmVO d, CIPRuntimeOperator operateInf);
	
	public void updateOutStoreData(EMS_storage_spare_dmVO d, CIPRuntimeOperator operateInf);
	
	public void addData(EMS_storage_spare_dmVO d, CIPRuntimeOperator operateInf);
