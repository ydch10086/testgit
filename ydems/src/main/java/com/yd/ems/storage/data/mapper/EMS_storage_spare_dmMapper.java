 ...
 */
public class EMS_storage_spare_dmMapper implements RowMapper<Map<String, Object>> {
	...
	public Map<String, Object> mapRow(ResultSet rs, int i) throws SQLException {
		Map<String, Object> data = new LinkedHashMap<String, Object>();
			...
			System.out.println(rs.getString("spare_store_id"));
			...
			data.put("spare_in_store_date", rs.getString("spare_in_store_date"));
			data.put("spare_out_store_date", rs.getString("spare_out_store_date"));
		return data;
	}
}