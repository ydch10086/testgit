...
@Repository
public class EMS_storage_logDaoImpl extends IDaoImpl<EMS_storage_logPO> 
						implements EMS_storage_logDao {
	
	private final BeanPropertyRowMapper<EMS_storage_logData> dataRM = BeanPropertyRowMapper.newInstance(EMS_storage_logData.class);
	
	public EMS_storage_logDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_storage_log";
	...
	private EMS_storage_logMapper mapperRM = new EMS_storage_logMapper();
