...
/**
 * <p>Dao实现类</p>
 * <p>Class: storage_inrecord_dm - 入库记录</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_storage_inrecord_dmDaoImpl extends IDaoImpl<EMS_storage_inrecord_dmPO> 
						implements EMS_storage_inrecord_dmDao {
	
	private final BeanPropertyRowMapper<EMS_storage_inrecord_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_storage_inrecord_dmData.class);
	
	public EMS_storage_inrecord_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_storage_inrecord_dm";
	...
	public List<EMS_storage_inrecord_dmData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		/*try{
			...
			List<Object> params = new ArrayList<Object>();
			String querySql = generateQuerySql(page, conditions, params);
			List<EMS_storage_inrecord_dmData> storelist;
			try {
				storelist = jdbcTemplate.query(querySql.toString(),
						params.toArray(), dataRM);
			} catch (Exception e) {
				System.out.println(e);
				throw e;
			}
	...
	private EMS_storage_inrecord_dmMapper mapperRM = new EMS_storage_inrecord_dmMapper();
