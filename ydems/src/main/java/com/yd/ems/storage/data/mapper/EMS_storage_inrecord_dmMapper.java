 ...
 */
public class EMS_storage_inrecord_dmMapper implements RowMapper<Map<String, Object>> {
	...
	public Map<String, Object> mapRow(ResultSet rs, int i) throws SQLException {
		Map<String, Object> data = new LinkedHashMap<String, Object>();
		    data.put("inrecord_id", rs.getString("inrecord_id"));
			...
			data.put("store_person_id", rs.getString("store_person_id"));
			data.put("store_person_name", rs.getString("store_person_name"));
			data.put("in_store_type", rs.getString("in_store_type"));
