...
@Repository
public class EMS_storage_spare_dmDaoImpl extends IDaoImpl<EMS_storage_spare_dmPO> 
						implements EMS_storage_spare_dmDao {
	
	private final BeanPropertyRowMapper<EMS_storage_spare_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_storage_spare_dmData.class);
	
	public EMS_storage_spare_dmDaoImpl() {
		super();
	...
	public List<EMS_storage_spare_dmData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		/*try{
			...
			List<Object> params = new ArrayList<Object>();
			String querySql = generateQuerySql(page, conditions, params);
			List<EMS_storage_spare_dmData> storelist;
			try {
	...
	private EMS_storage_spare_dmMapper mapperRM = new EMS_storage_spare_dmMapper();
