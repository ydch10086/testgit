...
@Service
public interface EMS_storage_outrecord_dmService {

	public void updateData(EMS_storage_outrecord_dmVO d, CIPRuntimeOperator operateInf);
	
	public void addData(EMS_storage_outrecord_dmVO d, CIPRuntimeOperator operateInf);
