...
@Repository
public class EMS_storage_classDaoImpl extends IDaoImpl<EMS_storage_classPO> 
						implements EMS_storage_classDao {
	
	private final BeanPropertyRowMapper<EMS_storage_classData> dataRM = BeanPropertyRowMapper.newInstance(EMS_storage_classData.class);
	
	public EMS_storage_classDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_storage_class";
	...
	private EMS_storage_classMapper mapperRM = new EMS_storage_classMapper();
