 ...
 */
public class EMS_storage_op_docPO {
    ...
    */
	...
	public EMS_storage_op_docVO toVO(){
		EMS_storage_op_docVO vo = new EMS_storage_op_docVO();
		
    	vo.setDoc_no(doc_no);
		vo.setCla_id(cla_id);
		vo.setDoc_year(doc_year);
		vo.setDoc_month(doc_month);
		vo.setDoc_op_type(doc_op_type);
		vo.setOp_type(op_type);
		vo.setDoc_op_amt(doc_op_amt);
		vo.setDoc_unit(doc_unit);
		vo.setOp_emp(op_emp);
		vo.setOp_date(op_date);
		vo.setUse_emp(use_emp);
		vo.setUse_time(use_time);
		vo.setUse_org(use_org);
		vo.setOp_org(op_org);
