...
/**
 * <p>实体mapper类</p>
 * <p>Table: em_storage_outrecord_dm - 出库记录</p>
 *
 * @since 2015-05-29 02:42:12
 */
public class EMS_storage_outrecord_dmMapper implements RowMapper<Map<String, Object>> {
	...
	public Map<String, Object> mapRow(ResultSet rs, int i) throws SQLException {
		Map<String, Object> data = new LinkedHashMap<String, Object>();
		    data.put("outrecord_id", rs.getString("outrecord_id"));
			...
			data.put("spare_sub_type_name", rs.getString("spare_sub_type_name"));
			...
			data.put("out_store_person_id", rs.getInt("out_store_person_id"));
			data.put("out_store_person_name", rs.getString("out_store_person_name"));
			data.put("user_taken_id", rs.getInt("user_taken_id"));
			data.put("user_taken_name", rs.getString("user_taken_name"));
			data.put("user_taken_type", rs.getInt("user_taken_type"));
