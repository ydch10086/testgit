...
/**
 * <p>Dao实现类</p>
 * <p>Class: storage_inout_dm - 备品备件主数据</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_storage_inout_dmDaoImpl extends IDaoImpl<EMS_storage_inout_dmPO> 
						implements EMS_storage_inout_dmDao {
	
	private final BeanPropertyRowMapper<EMS_storage_inout_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_storage_inout_dmData.class);
	
	public EMS_storage_inout_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_storage_inout_dm";
	...
	public List<EMS_storage_inout_dmData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		/*try{
			...
			List<Object> params = new ArrayList<Object>();
			String querySql = generateQuerySql(page, conditions, params);
			List<EMS_storage_inout_dmData> storelist;
			try {
	...
	private EMS_storage_inout_dmMapper mapperRM = new EMS_storage_inout_dmMapper();
