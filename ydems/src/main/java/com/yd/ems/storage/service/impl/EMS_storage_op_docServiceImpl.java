...
@Service
public class EMS_storage_op_docServiceImpl implements EMS_storage_op_docService {
	
	@Autowired
	private EMS_storage_op_docDao dataDao = null;
	@Autowired
	 ...
	 */
	@Override
	public void updateData(EMS_storage_op_docVO vo, CIPRuntimeOperator operateInf){
		//TODO
		EMS_storage_op_docPO po = vo.toPO();
		Object[] keys = po.getKeys();
		EMS_storage_op_docPO po0 = dataDao.getSingle(keys);
		if( po0 == null ){
	 ...
	 */
	@Override
	public void addData(EMS_storage_op_docVO vo, CIPRuntimeOperator operateInf){
		EMS_storage_op_docPO po = vo.toPO();
		Object[] keys = po.getKeys();
		EMS_storage_op_docPO po0 = dataDao.getSingle(keys);
		if( po0!= null ){
	...
	public EMS_storage_op_docVO getData(Object[] keys ){
		EMS_storage_op_docPO  po = dataDao.getSingle(keys);
		if(po == null)
			throw new CIPServiceException(CIPErrorCode.ERROR_RECORD_NOT_EXISTS);
	...
	public List<EMS_storage_op_docData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		...
		List<EMS_storage_op_docData> datas = dataDao.searchData(page, conditions);
		return datas;
	}
	...
	public List<Map<String, Object>> exportEntities(CIPPageInfo page,CIPReqCondition[] conditions,
		...
		if(xFirst){
			...
			log.setOp_table_id("em_storage_op_doc");
			log.setOp_obj_id("");
			log.setOp_type("E");
