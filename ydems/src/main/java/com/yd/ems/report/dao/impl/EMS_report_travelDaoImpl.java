...
@Repository
public class EMS_report_travelDaoImpl extends IDaoImpl<EMS_report_travelPO> 
						implements EMS_report_travelDao {
	
	private final BeanPropertyRowMapper<EMS_report_travelData> dataRM = BeanPropertyRowMapper.newInstance(EMS_report_travelData.class);
	
	public EMS_report_travelDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_report_travel";
	...
	private EMS_report_travelMapper mapperRM = new EMS_report_travelMapper();
