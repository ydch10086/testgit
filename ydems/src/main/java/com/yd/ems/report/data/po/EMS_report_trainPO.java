 ...
 */
public class EMS_report_trainPO {
    ...
    */
	...
	public EMS_report_trainVO toVO(){
		EMS_report_trainVO vo = new EMS_report_trainVO();
		
    	vo.setTrain_no(train_no);
		vo.setTrain_purchse(train_purchse);
		vo.setTrain_object(train_object);
		vo.setTrain_comment(train_comment);
		vo.setTrain_teacher(train_teacher);
		vo.setTrain_time(train_time);
