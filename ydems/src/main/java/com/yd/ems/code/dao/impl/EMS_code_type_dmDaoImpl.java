...
@Repository
public class EMS_code_type_dmDaoImpl extends IDaoImpl<EMS_code_type_dmPO> 
						implements EMS_code_type_dmDao {
	
	private final BeanPropertyRowMapper<EMS_code_type_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_code_type_dmData.class);
	
	public EMS_code_type_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_code_type_dm";
	...
	private EMS_code_type_dmMapper mapperRM = new EMS_code_type_dmMapper();
