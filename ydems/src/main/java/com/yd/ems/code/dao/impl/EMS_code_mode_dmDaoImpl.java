...
/**
 * <p>Dao实现类</p>
 * <p>Class: code_mode_dm - 设备型号类型</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_code_mode_dmDaoImpl extends IDaoImpl<EMS_code_mode_dmPO> 
						implements EMS_code_mode_dmDao {
	
	private final BeanPropertyRowMapper<EMS_code_mode_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_code_mode_dmData.class);
	
	public EMS_code_mode_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_code_mode_dm";
	...
	private EMS_code_mode_dmMapper mapperRM = new EMS_code_mode_dmMapper();
