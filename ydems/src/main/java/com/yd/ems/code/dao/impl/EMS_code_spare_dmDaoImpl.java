...
/**
 * <p>Dao实现类</p>
 * <p>Class: code_spare_dm - 备品备件主数据</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_code_spare_dmDaoImpl extends IDaoImpl<EMS_code_spare_dmPO> 
						implements EMS_code_spare_dmDao {
	
	private final BeanPropertyRowMapper<EMS_code_spare_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_code_spare_dmData.class);
	
	public EMS_code_spare_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_code_spare_dm";
	...
	private EMS_code_spare_dmMapper mapperRM = new EMS_code_spare_dmMapper();
