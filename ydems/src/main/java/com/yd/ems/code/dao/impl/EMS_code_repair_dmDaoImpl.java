...
@Repository
public class EMS_code_repair_dmDaoImpl extends IDaoImpl<EMS_code_repair_dmPO> 
						implements EMS_code_repair_dmDao {
	
	private final BeanPropertyRowMapper<EMS_code_repair_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_code_repair_dmData.class);
	
	public EMS_code_repair_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_code_repair_dm";
	...
	private EMS_code_repair_dmMapper mapperRM = new EMS_code_repair_dmMapper();
