...
/**
 * <p>Dao实现类</p>
 * <p>Class: code_relate_dm - 对象类型子类型关系</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_code_relate_dmDaoImpl extends IDaoImpl<EMS_code_relate_dmPO> 
						implements EMS_code_relate_dmDao {
	
	private final BeanPropertyRowMapper<EMS_code_relate_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_code_relate_dmData.class);
	
	public EMS_code_relate_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_code_relate_dm";
	...
	private EMS_code_relate_dmMapper mapperRM = new EMS_code_relate_dmMapper();
