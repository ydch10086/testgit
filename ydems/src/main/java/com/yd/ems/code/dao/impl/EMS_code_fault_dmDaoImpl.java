...
@Repository
public class EMS_code_fault_dmDaoImpl extends IDaoImpl<EMS_code_fault_dmPO> 
						implements EMS_code_fault_dmDao {
	
	private final BeanPropertyRowMapper<EMS_code_fault_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_code_fault_dmData.class);
	
	public EMS_code_fault_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_code_fault_dm";
	...
	private EMS_code_fault_dmMapper mapperRM = new EMS_code_fault_dmMapper();
