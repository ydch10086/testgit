...
@Repository
public class EMS_parameterDaoImpl extends IDaoImpl<EMS_parameterPO> 
						implements EMS_parameterDao {
	
	private final BeanPropertyRowMapper<EMS_parameterData> dataRM = BeanPropertyRowMapper.newInstance(EMS_parameterData.class);
	
	public EMS_parameterDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_parameter";
	...
	private EMS_parameterMapper mapperRM = new EMS_parameterMapper();
