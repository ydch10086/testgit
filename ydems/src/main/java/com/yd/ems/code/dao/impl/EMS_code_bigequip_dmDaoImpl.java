...
/**
 * <p>Dao实现类</p>
 * <p>Class: code_bigequip_dm - 备品备件主数据</p>
 *
 * @since 2015-05-29 02:42:12
 */
 
@Repository
public class EMS_code_bigequip_dmDaoImpl extends IDaoImpl<EMS_code_bigequip_dmPO> 
						implements EMS_code_bigequip_dmDao {
	
	private final BeanPropertyRowMapper<EMS_code_bigequip_dmData> dataRM = BeanPropertyRowMapper.newInstance(EMS_code_bigequip_dmData.class);
	
	public EMS_code_bigequip_dmDaoImpl() {
		super();
		this.tableName = CIPRuntimeConfigure.dbSchema + "em_code_bigequip_dm";
	...
	private EMS_code_bigequip_dmMapper mapperRM = new EMS_code_bigequip_dmMapper();
